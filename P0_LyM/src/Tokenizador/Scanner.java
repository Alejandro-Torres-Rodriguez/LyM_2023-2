...
public class Scanner {
    ...
    //definimos token en Arrays de string para poderlos comparar con los tokens que traemos por archivo
    ...
    public Scanner() {
                     // Atributo para almacenar los tokens del archivo
    }
        /**
         * Esta parte del codigo se encarga de decirle que tipo de token es y asi evaluarlo
         * Aprovecho de las expresiones regulares y el hecho de que matches() funciona de cierta forma
         * como un regex que me deja evaluar tanto una expresion regular como un string
         */
     ...
     */
    public boolean lectorTexto(List<String> tokens){
